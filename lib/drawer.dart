    ...
    return Drawer(
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            leading: SvgPicture.asset("assets/icons/grid.svg",
                width: 30, height: 30),
          ...
          ListTile(
            leading: SvgPicture.asset("assets/icons/promos.svg",
                width: 30, height: 30),
            title: Text("À propos"),
            onTap: () {
              // Update the state of the app
          ...
          ListTile(
            leading: SvgPicture.asset("assets/icons/forums.svg",
                width: 30, height: 30),
          ...
          ListTile(
            leading: SvgPicture.asset("assets/icons/spam.svg",
                width: 30, height: 30),
