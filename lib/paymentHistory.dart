...
class FactureLine extends StatelessWidget {
  ...
  const FactureLine(
      {Key key, this.numeroFacture, this.total, this.date, this.status})
      : super(key: key);
            ...
            child: Column(
              children: <Widget>[
                Row(
                  ...
                  children: <Widget>[
                    Text(
                      "Facture N° " + this.numeroFacture,
                      style: alternateSecondaryTextStyle,
                    ),
                    Text(this.total + " DA",
                        style: alternateSecondaryTextStyle600)
                  ],
                ),
                SizedBox(height: 10),
                Row(
      ...
      body: Container(
        ...
        child: Column(children: [
          ...
          Align(
            ...
            child:
                Text("Historique des payments ", style: basePrimaryTextStyle),
          ),
          SizedBox(height: 10),
